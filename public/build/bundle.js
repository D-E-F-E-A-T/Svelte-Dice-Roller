    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "svelte-3a76w3");
    			add_location(h1, file, 105, 6, 1544);
    			attr_dev(div0, "class", "svelte-3a76w3");
    			add_location(div0, file, 104, 4, 1532);
    			add_location(br1, file, 107, 4, 1585);
    			attr_dev(h30, "class", "svelte-3a76w3");
    			add_location(h30, file, 109, 6, 1621);
    			attr_dev(button0, "class", "svelte-3a76w3");
    			add_location(button0, file, 110, 6, 1651);
    			attr_dev(button1, "class", "svelte-3a76w3");
    			add_location(button1, file, 111, 6, 1693);
    			attr_dev(h31, "class", "svelte-3a76w3");
    			add_location(h31, file, 112, 6, 1737);
    			attr_dev(button2, "class", "svelte-3a76w3");
    			add_location(button2, file, 113, 6, 1763);
    			attr_dev(button3, "class", "svelte-3a76w3");
    			add_location(button3, file, 114, 6, 1806);
    			attr_dev(h32, "class", "svelte-3a76w3");
    			add_location(h32, file, 115, 6, 1851);
    			attr_dev(button4, "class", "svelte-3a76w3");
    			add_location(button4, file, 116, 6, 1875);
    			attr_dev(div1, "class", "dice svelte-3a76w3");
